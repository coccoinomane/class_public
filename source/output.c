...
int output_init(
  ...
  if ((ppt->has_cls == _FALSE_) && (ppt->has_pk_matter == _FALSE_) && (pfi->has_fisher == _FALSE_) && (ppt->has_density_transfers == _FALSE_) && (ppt->has_velocity_transfers == _FALSE_) && (pop->write_background == _FALSE_) && (pop->write_thermodynamics == _FALSE_) && (pop->write_primordial == _FALSE_)) {
